    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult GetUserList()
        {
            try
            {
                ...
                select new {u.UserId,u.UserRoleId,u.FullName,r.RoleName,u.Mobile,u.Email,u.DateOfBirth,u.UserName,u.ImagePath,u.HospitalMasterid,p.HospitalName});

                var userInfoList=list.Select(s=>new UserInfo
                {UserId=s.UserId,UserRoleId=s.UserRoleId,RoleName=s.RoleName,FullName=s.FullName,Mobile=s.Mobile,Email=s.Email,DateOfBirth=s.DateOfBirth,UserName=s.UserName,ImagePath=s.ImagePath,HospitalMasterid=s.HospitalMasterid,HospitalName=s.HospitalName});
