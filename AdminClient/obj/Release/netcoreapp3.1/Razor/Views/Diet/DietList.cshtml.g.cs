#pragma checksum "E:\Pravat Project\Yatris\AdminConsole\AdminClient\Views\Diet\DietList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "497e80ae4c21bb6a3e829a6fa5d6806039122c9b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"497e80ae4c21bb6a3e829a6fa5d6806039122c9b", @"/Views/Diet/DietList.cshtml")]
    #nullable restore
...
<div class=""page-header"">
    ...
    <div class=""ml-auto"">
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "497e80ae4c21bb6a3e829a6fa5d6806039122c9b4614", async() => {
        ...
        function loadDiet() {
             ...
             table = $('#diet').dataTable({
                ...
                ""ajax"": {
                    ""url"": '");
#nullable restore
#line 129 "E:\Pravat Project\Yatris\AdminConsole\AdminClient\Views\Diet\DietList.cshtml"
                       Write(apiUrl);
...
#nullable restore
#line 133 "E:\Pravat Project\Yatris\AdminConsole\AdminClient\Views\Diet\DietList.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"     }
                    ...
                    },
                    {
                        ...
                        ""render"": function (data) {
                            ...
                            var month = date.getMonth() + 1;
                            ret");
                WriteLiteral(@"urn (month.length > 1 ? month : ""0"" + month) + ""/"" + date.getDate() + ""/"" + date.getFullYear() + ""&nbsp;&nbsp;"" + (date.getHours() < 10 ? (""0"" + date.getHours()) : date.getHours()) + "":"" + (date.getMinutes() < 10 ? (""0"" + date.getMinutes()) : date.getMinutes());
                        }
                    },
                    {
                        ""render"": function (data, type, row) {
           ...
           ");
                WriteLiteral(@"                 }
                    ...
                    {
                        ""render"": function (data, type, row) {
                            return '<button class=""btn btn-success"" data-target=""#delete"" data-id=' + row.dietMasterId + ' data-title=""Delete""><i class=""fe fe-check mr-2""></i>Discharge</button> ';
                        }
                    }
        ...
        $('#diet tbody').on('click', 'button[data-target=""#delete""]', function () {
         ...
         ");
                ...
                $.ajax({
                    ...
                    url: """);
#nullable restore
#line 256 "E:\Pravat Project\Yatris\AdminConsole\AdminClient\Views\Diet\DietList.cshtml"
                     Write(apiUrl);
...
#nullable restore
#line 259 "E:\Pravat Project\Yatris\AdminConsole\AdminClient\Views\Diet\DietList.cshtml"
                                           Write(Context.Session.GetString("TokenTxt"));
