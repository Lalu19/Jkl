#pragma checksum "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "b50275c7ff34232dc7c46ea3d2ab08211e4f9e18cb5abc6f3c19d4fdcabba74e"
// <auto-generated/>
...
#nullable restore
#line 1 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
...
#nullable disable
#nullable restore
#line 2 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"b50275c7ff34232dc7c46ea3d2ab08211e4f9e18cb5abc6f3c19d4fdcabba74e", @"/Views/Diet/SuperAdminDietList.cshtml")]
    #nullable restore
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 5 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
...
<div class=""page-header"">
    ...
    <div class=""ml-auto"">
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b50275c7ff34232dc7c46ea3d2ab08211e4f9e18cb5abc6f3c19d4fdcabba74e4842", async() => {
         ...
         ");
            WriteLiteral(@"                   </div>
                        ...
                        <div class=""col-md-6 col-lg-4 col-sm-6"">
                            <div class=""d-flex align-items-center mb-3 mt-3"">
                                <div class=""w");
            WriteLiteral(@"-7 h-7 bg-red  mr-4""></div>
                                <div>
        ...
        function loadDiet() {
            ...
            table = $('#diet').dataTable({
                ...
                ""ajax"": {
                    ""url"": '");
#nullable restore
#line 130 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
                       Write(apiUrl);
...
#nullable restore
#line 134 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
...
#nullable disable
        ...
        ");
                WriteLiteral(@"                    }
                    ...
                    },
                    {
                        ...
                        ""render"": function (data) {
                            ...
                            return (month.length > 1 ? month : ""0"" +");
                WriteLiteral(@" month) + ""/"" + date.getDate() + ""/"" + date.getFullYear() + ""&nbsp;&nbsp;"" + (date.getHours() < 10 ? (""0"" + date.getHours()) : date.getHours()) + "":"" + (date.getMinutes() < 10 ? (""0"" + date.getMinutes()) : date.getMinutes());
                        }
                    },
                    {
               ...
               ");
                ...
                WriteLiteral(@" row.feedback + '</span>';
                            }
                    ...
                    {
                        ""render"": function (data, type, row) {
                            return '<a class=""btn btn-success"" href=""../Diet/DietEdit?dietMasterId=' + row.dietMasterId + '""><i class=""fa fa-edit""></i></a>'+'&nbsp<button class=""btn btn-icon  btn-danger"" da");
                WriteLiteral(@"ta-target=""#delete"" data-id=' + row.dietMasterId + ' data-title=""Delete""><i class=""fe fe-trash""></i></button> ' + '<button class=""btn btn-icon  btn-primary-y"" data-target=""#discharge"" data-id=' + row.dietMasterId + ' data-title=""Discharge""><i class=""fe fe-activity""></i></button>';
                        }
                    }
        ...
        $('#diet tbody').on('click', 'button[data-target=""#delete""]', function () {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    url: """);
#nullable restore
#line 263 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
                     Write(apiUrl);
...
#nullable restore
#line 266 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
                                            Write(Context.Session.GetString("TokenTxt"));
        ...
        $('#diet tbody').on('click', 'button[data-target=""#discharge""]', function () {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    url: """);
#nullable restore
#line 309 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
                     Write(apiUrl);
...
#nullable restore
#line 312 "\\APPMAN\1. Public Folder\Tanmay\AdminConsole\AdminClient\Views\Diet\SuperAdminDietList.cshtml"
                                            Write(Context.Session.GetString("TokenTxt"));
